...
LEGACY_CALL_SITES: dict[tuple[str, str], tuple[int, str]] = {
    ...
    ("api/assessments.py", "_enqueue_matrix_from_swot"): (1, "P1"),
    ("api/assessments.py", "_framework_repair_pending"): (1, "P1"),
    ...
    ("api/jobs.py", "publish_job"): (2, "P1"),
    ("api/jobs.py", "submit_job"): (1, "P1 proposed"),
    ("api/jobs.py", "upload_databank_candidates"): (2, "P2"),
    ("api/matching.py", "list_matching_categories"): (1, "P2 proposed"),
    ("api/matching.py", "run_matching"): (1, "P2"),
    ("api/outreach.py", "send_outreach"): (1, "P6"),
    ("api/pipeline.py", "_queue_transition_email"): (1, "P6"),
    ("api/pipeline.py", "select_candidates_for_assessment"): (1, "P3"),
    ("api/portal.py", "add_project"): (1, "P6 proposed"),
    ("api/portal.py", "apply_to_job"): (3, "P3"),
    ("api/portal.py", "delete_my_profile"): (2, "P6"),
    ("api/portal.py", "dispatch_bgv_inquiry"): (1, "P6 proposed"),
    ("api/portal.py", "edit_application"): (2, "P2 proposed"),
    ("api/portal.py", "outreach_submit"): (1, "P6 proposed"),
    ("api/portal.py", "replace_main_resume"): (1, "P6 proposed"),
