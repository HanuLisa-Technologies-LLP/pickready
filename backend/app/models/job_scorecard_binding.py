...
WHAT HELD THE LINE for this table was the matrix reopen route (deleted in the
...
at the first start (`assessment_contract.lock_contract`) replaces it, and the
snapshot it writes is what a candidate's assessment reads.
"""
