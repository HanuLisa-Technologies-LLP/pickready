...
# ── The shared detectors, which live in `observable` ─────────────────────
#
# Re-exported rather than defined here: `swot_quality` and `scorecard` hold
# their own inputs to the same bar, and two copies of a fairness detector
# drift invisibly.
from app.services.hiring.observable import (  # noqa: E402
    PROHIBITED_DISQUALIFIERS,
    is_observable,
    prohibited_in,
    rejection_message,
