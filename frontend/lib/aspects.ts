...
export const ASPECTS: AspectDef[] = [
  ...
  { id: 40, category: "Verification & Consent", question: "Do you consent to your profile being retained in the Vivekium Databank and matched against future roles?", type: "boolean" },
];
