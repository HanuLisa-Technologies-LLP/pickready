...
// mounted unchanged: it talks to the Firebase client SDK and calls no Vivekium
            ...
            {loadError ? (
              ...
              <form className="space-y-4" onSubmit={save} noValidate>
                ...
                <FormField
                  ...
                  required
                  error={errors.email}
                  hint="This updates your Vivekium record. Your sign-in identity is managed separately."
                >
                  <Input
                    id="bd-email"
                    type="email"
