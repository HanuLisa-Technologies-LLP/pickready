...
export const metadata: Metadata = {
  title: "Privacy",
  description: "How PickReady handles candidate, customer and visitor information.",
};
...
const SECTIONS = [
  ...
  ["Consent and notices", "Where processing relies on consent, the interface states the purpose before collection. Separate controls cover background or previous-employer verification and retention in the PickReady Databank for future role matching. Withdrawing Databank consent stops future reuse; it does not erase records that must be retained for a live application or legal obligation."],
  ["AI and human decisions", "AI assists with extraction, matching, drafting and structured analysis. It does not make the final customer decision. Customers remain responsible for reviewing evidence and deciding whether to progress a candidate. PickReady records key actions for later review."],
  ...
  return (
    <main id="main" className="mx-auto max-w-4xl px-6 py-20 lg:px-10 lg:py-28">
      ...
      <p className="mt-5 text-lg leading-8">
        This notice explains how PickReady handles digital personal data. It is designed to support the Digital Personal Data Protection Act, 2023 and the Digital Personal Data Protection Rules, 2025 as their provisions become applicable.
      </p>
