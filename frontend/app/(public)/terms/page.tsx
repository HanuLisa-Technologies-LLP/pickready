...
export const metadata: Metadata = {
  title: "Terms",
  description: "Terms governing access to and use of PickReady.",
};

const TERMS = [
  ["Using PickReady", "You may use PickReady only through an authorised account and for lawful candidate and people operations. Keep account credentials secure, provide accurate information and promptly remove access for people who no longer need it."],
  ["Customer responsibility", "Customers decide which roles to publish, which candidates to progress and what messages to send. AI output is decision support and must be reviewed by an authorised team member. Customers are responsible for having a lawful basis and giving required notices for data they upload or ask PickReady to process."],
  ...
  ["Intellectual property", "PickReady, the PPI framework, product design, software and platform content belong to PickReady or its licensors. Customers and candidates retain rights in the information they submit and grant the limited permission needed to operate the requested service."],
  ...
  ["Liability", "To the extent permitted by law, PickReady is not responsible for a customer’s final candidate decision, indirect losses or information supplied by another user. Nothing in these terms limits a right or liability that cannot lawfully be limited."],
  ...
  return (
    <main id="main" className="mx-auto max-w-4xl px-6 py-20 lg:px-10 lg:py-28">
      ...
      <p className="mt-5 text-lg leading-8">
        These terms govern access to PickReady. A signed customer agreement or order form may add commercial terms; if it conflicts with this page, the signed document controls for that customer.
      </p>
