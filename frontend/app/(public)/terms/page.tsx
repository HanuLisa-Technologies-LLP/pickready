...
const TERMS = [
  ...
  ["Intellectual property", "Vivekium, the Tatva Assessment framework, product design, software and platform content belong to Vivekium or its licensors. Customers and candidates retain rights in the information they submit and grant the limited permission needed to operate the requested service."],
