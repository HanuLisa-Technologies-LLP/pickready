...
export const metadata: Metadata = publicPageMetadata({
  ...
  title: "Terms",
  description:
    "Terms governing access to and use of Vivekium.",
});

const TERMS = [
  ["Using Vivekium", "You may use Vivekium only through an authorised account and for lawful candidate and people operations. Keep account credentials secure, provide accurate information and promptly remove access for people who no longer need it."],
  ["Customer responsibility", "Customers decide which roles to publish, which candidates to progress and what messages to send. AI output is decision support and must be reviewed by an authorised team member. Customers are responsible for having a lawful basis and giving required notices for data they upload or ask Vivekium to process."],
  ...
  ["Intellectual property", "Vivekium, the Tatva Assessment, the PRISM Report, product design, software and platform content belong to Vivekium or its licensors. Customers and candidates retain rights in the information they submit and grant the limited permission needed to operate the requested service."],
  ...
  ["Liability", "To the extent permitted by law, Vivekium is not responsible for a customer’s final candidate decision, indirect losses or information supplied by another user. Nothing in these terms limits a right or liability that cannot lawfully be limited."],
