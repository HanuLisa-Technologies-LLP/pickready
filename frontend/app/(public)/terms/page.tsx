...
const TERMS = [
  ...
  ["Intellectual property", "ReadyPick, the PPI framework, product design, software and platform content belong to ReadyPick or its licensors. Customers and candidates retain rights in the information they submit and grant the limited permission needed to operate the requested service."],
