...
// HR Review Screen (FR-7.1): candidate names on the left, the selected
// candidate's 40 aspects + verification + resume on the right, with the
// grant-HM-access action.
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Review each candidate's complete Profile — resume, 40 aspects and employer verification."
        actions={
