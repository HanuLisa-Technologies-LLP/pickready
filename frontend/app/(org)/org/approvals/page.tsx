...
// Approvals queue: jobs awaiting this approver's decision at the current
// level. Approve / Reject with optional remarks (FR-3.2).
// Nav-gated by capability `approve_job`; the server checks the actor is the
// assigned approver of the job's current level.
